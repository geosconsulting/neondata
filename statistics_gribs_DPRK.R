...
fname = "C:/meteorological/ecmwf/1_gribs_from_ecmwf/Dem_2902_08_09_19792016.grib"
GDALinfo(fname)
...
primi_5_giorni = grib_stack@layers[[1]] + grib_stack@layers[[2]] +
...
MeanDaGribs <- mean(primi_5_giorni)

writeRaster(MeanDaGribs,"_mean_DemRepKore5_daR.tiff", format="GTiff", overwrite=TRUE, NAflag=-9999)
...
last_forecast <- raster("C:/meteorological/ecmwf/3_ecmwf_ftp_wfp/tp_nepal3008.tif")
